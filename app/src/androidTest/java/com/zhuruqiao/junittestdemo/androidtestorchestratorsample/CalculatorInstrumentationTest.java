...
import com.zhuruqiao.junittestdemo.androidjunitrunnersample.CalculatorActivity;
...
/**
 *此案列很肤浅的告诉了我们如何找到某个控件并对其做操作，里面涉及有打开待测试的Activity及找到其中的某个控件，赋值并点击。
 *
 *
 */
...
public class CalculatorInstrumentationTest {
    ...
    private void performOperation(int btnOperationResId, String operandOne,
        ...
        // 找到id为R.id.operand_one_edit_text的控件 输入operandOne 然后关闭键盘
